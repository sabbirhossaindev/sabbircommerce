        ...
        <div class="">
            ...
            <footer class="text-center text-lg-start text-dark" style="background-color: #ECEFF1">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-3">
                                ...
                                <hr class="mb-4 mt-0 d-inline-block mx-auto"
                                    style="width: 60px; background-color: #7c4dff; height: 2px" />
                                <p>
                                    <a href="https://www.facebook.com/profile.php?id=100066520511940"
                                        class="text-white">
                                ...
                                <p>
                                    <a href="https://www.linkedin.com/in/md-sabbir-hossain-18300b244/"
                                        class="text-white">
                            ...
                            <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                                ...
                                <p><i class="mdi mdi-email-outline mr-1 text-warning"></i>mdsabbir477470@gmail.com
                                </p>
                ...
                <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2)">
                    <span class="text-muted d-block text-center text-sm d-sm-inline-block">copyright ©
                        2019-<?php echo date("Y");?> sabbircommerce. All
                        rights reserved.
                    </span>
                </div>
                <!-- Copyright -->

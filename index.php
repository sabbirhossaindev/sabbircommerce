...
<div class="container">
    <h1 class="text-center text-primary my-4">Simple Cart</h1>

    <div class="row">
        <div class="col-md-4">
            <div class="card" style="width: 18rem;">
                <img src="uploads/3.jpg" class="card-img-top">

                <div class="card-body">
                    <h5 class="card-title">Product 1</h5>
                    <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolore excepturi quam
                        quia quo alias iste magni et.</p>
        ...
        <div class="col-md-4">
            <div class="card" style="width: 18rem;">
                <img src="uploads/2.jpg" class="card-img-top">
